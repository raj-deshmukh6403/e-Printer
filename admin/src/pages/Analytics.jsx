    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          ...
          {/* Users Table - Status Column Removed */}
      ...
      {/* User Details Modal - Updated to show correct statistics */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className={`ml-2 px-2 py-1 text-xs rounded-full ${
                      ...
                      {selectedUser.isVerified ? 'Verified' : 'Verified'}
                    </span>
                  </div>
                  <div>
              ...
              {/* Activity Stats - Updated to handle missing data gracefully */}
              <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {selectedUser.printRequestsCount !== undefined 
                          ? selectedUser.printRequestsCount 
                          : 'N/A'}
                      </p>
                      {selectedUser.printRequestsCount === undefined && (
                        <p className="text-xs text-orange-600">Data not available</p>
                      )}
                    </div>
                  </div>
                  <div className="flex items-center">
                ...
                {/* Warning message if statistics are missing */}
                {(selectedUser.printRequestsCount === undefined || selectedUser.totalSpent === undefined) && (
                  <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                    <p className="text-sm text-orange-800">
                      <strong>Note:</strong> User statistics are not available. 
                      This may indicate that the backend API needs to be updated to include 
                      aggregated user data (printRequestsCount and totalSpent fields).
                    </p>
                  </div>
                )}
              </div>
